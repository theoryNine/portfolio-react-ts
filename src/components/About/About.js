...
const About = () => {
    return(
        <AboutWrapper>
            ...
            <p>Outside of code I have a love of traveling and a passion to explore and look forward to plenty of years of wandering the globe. I spend my weekends wandering the city walking for miles, taking a roadtrip to a forest trail, gaming on my PC, or toying with code on the couch.</p>
